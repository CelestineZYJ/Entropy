...
class SFTModule(pl.LightningModule):
    def __init__(
        ...
        # no pretrained weights without weights version0 with weights version1
        ...
        if load_pretrained:
            ...
            self.model = GPTNeoXForCausalLM(AutoConfig.from_pretrained(model_name,trust_remote_code=True))
