...
class SFTDataModule(pl.LightningDataModule):
    def __init__(
        ...
        batch_size:int=8,
        seq_len:int=1024,
        tokenizer_name:str="EleutherAI/pythia-160m-deduped", # EleutherAI/pythia-2.8b  EleutherAI/pythia-1b-deduped
        concat_samples:bool=True,
    ...
    def setup(self, stage: str):
        ...
        current_dir = 'alength_synthetic/' # 'vocab10k_len30_scale100k/'# aRandomb111_multiGroup_10k_10 domi_timestamp_100 negation_25
        if stage == "fit":
